...
Query.prototype.insert = function(ignore) {
  this.parts.push('INSERT');
  ignore && this.parts.push('OR IGNORE');
  return this;
};

Query.prototype.into = function(table) {
  this.parts.push('INTO', this.escape(table));
  return this;
};
...
Query.prototype.fields = function() {
  ...
  this.parts.push('(');
  this.parts.push.apply(this.parts, args.map(() => {return '?';}).join(', '));
  this.parts.push(')');
  return this;
};
...
Query.prototype.limit = function(limit, offset) {
  this.parts.push('LIMIT', this.escape(limit));
  offset && this.parts.push('OFFSET', this.escape(offset));
  return this;
};
